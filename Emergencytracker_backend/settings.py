"""
Django settings for Emergencytracker_backend project.
...
ROOT_URLCONF = 'Emergencytracker_backend.urls'
...
WSGI_APPLICATION = 'Emergencytracker_backend.wsgi.application'
